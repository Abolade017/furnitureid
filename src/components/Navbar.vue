<template>
 <div class="flex space-x-20 justify-between items-center mx-auto max-w-4xl">
      <div>
        <div class="flex space-x-20 items-center absolute top-0 py-10">
          <router-link class="text-sm" to="/furnitureid">
